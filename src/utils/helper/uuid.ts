export default function uuid() {
    ...
    const part4 = Array.from(randB.slice(0, 2)).map(b => b.toString(16).padStart(2, '0')).join('');
    const part5 = Array.from(randB.slice(2)).map(b => b.toString(16).padStart(2, '0')).join('');
